...
public class Trial2_Old extends AppCompatActivity {
    ...
    //computed variables
    final Context context = Trial2_Old.this;  //context of current screen
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextScreenIntent = new Intent(this, Trial2_New.class);
