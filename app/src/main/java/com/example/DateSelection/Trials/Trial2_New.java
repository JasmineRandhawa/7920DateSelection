package com.example.DateSelection.Trials;
...
import com.example.DateSelection.Main.Common;
import com.example.DateSelection.Main.Data;
import com.example.DateSelection.Main.Trial;
import com.example.DateSelection.Main.TrialAttempt;
import com.example.DateSelection.NewDesign.MonthList;
import com.example.DateSelection.NewDesign.WheelList;
...
//This is trial 2 screen for combination medium date : old design
public class Trial2_New extends AppCompatActivity implements MonthList.OnSelectListener,
    ...
    final static String dateEra = "Medium";
    ...
    //computed variables
    final Context context = com.example.DateSelection.Trials.Trial2_New.this;  //context of current screen
        ...
        if (hasSuceeded) {
            ...
            if (successAttempts < totalAttempts) {
                listAttempts.add(new TrialAttempt(successAttempts,
                        Common.GetYearDiff(dateToSelect),timeTaken, noOfTaps, errorCount));
                StartNextTrialAttempt(false);
